...
import { ArrowLeft, User, Mail, Lock, Camera, Save, MessageCircle } from "lucide-react";
...
export default function Profile({ embedded = false }: { embedded?: boolean }) {
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="bg-card border border-border/50 rounded-[2.5rem] p-8 space-y-6 shadow-sm">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="whatsapp_number" className="text-[10px] font-black uppercase tracking-widest text-primary ml-1">Nomor WhatsApp</Label>
                <div className="relative">
                  <MessageCircle className="absolute left-4 top-3.5 h-4 w-4 text-muted-foreground/50" />
                  <Input 
                    id="whatsapp_number"
                    inputMode="tel"
                  ...
                  <div className="mt-2 text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                    Status: {formData.whatsapp_verified ? "Terverifikasi" : "Belum verifikasi"}
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="bottom-nav-safe pb-24">
